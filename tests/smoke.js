...
global.document = {
  ...
  querySelectorAll: () => [],
  getElementById: el,
  createElement: () => ({ style:{}, classList:{add(){}}, append(){}, appendChild(){}, textContent:'', set src(v){}, dataset:{} }),
  addEventListener(){}
};
...
const fs = require('fs');
for (const f of ['../scenes/opening','theme','performance','parallax','camera','animation','scene','interaction','renderer','init']) {
